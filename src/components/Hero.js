...
const Hero = () => {
  return (
    <div
      className="relative h-[70vh] md:h-[100vh]  lg:h-[60vh] flex flex-col items-center px-6 pt-30 bg-[#0a0a0a] overflow-hidden text-center"
      style={{
        backgroundImage: `
    ...
    >
      ...
      <Link
        to="paths"  // Aquí usamos el id del componente Paths
        smooth={true}  // Habilitamos el desplazamiento suave
